...
export interface ICPSquadHub {
  ...
  get_completed_missions: ActorMethod<[Principal], Array<[Mission__1, Time]>>;
  get_daily_events: ActorMethod<[Principal, Date], [] | [Array<ExtendedEvent>]>;
...
export type Result__1 = { ok: bigint } | { err: string };
export type Result__1_1 = { ok: null } | { err: string };
