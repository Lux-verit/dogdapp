...
export interface ICPSquadNFT {
  ...
  get_pending_transactions: ActorMethod<[], Array<[TokenIndex, Transaction]>>;
  ...
  record_token: ActorMethod<
    ...
    undefined
  >;
  remove_accessory: ActorMethod<[TokenIdentifier, TokenIdentifier], Result__1>;
...
export type ListResponse = { ok: null } | { err: CommonError__2 };
...
export type Result_5 = { ok: Inventory } | { err: string };
export type Result_6 = { ok: AccountIdentifier__2 } | { err: CommonError };
export type Result_7 = { ok: string } | { err: string };
export type Result__1 = { ok: null } | { err: string };
export type Result__1_1 = { ok: TokenIdentifier } | { err: string };
export type Result__1_2 = { ok: null } | { err: CommonError__1 };
