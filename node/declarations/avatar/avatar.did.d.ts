...
export interface ICPSquadNFT {
  ...
  get_infos_accounts: ActorMethod<[], Array<[Principal, AccountIdentifier__1]>>;
...
export type MintResult = { ok: TokenIdentifier } | { err: string };
...
export type Result_1 = { ok: Array<TokenIdentifier> } | { err: CommonError };
...
export type Result_4 = { ok: TokenIndex } | { err: string };
export type Result_5 = { ok: Metadata } | { err: CommonError__1 };
export type Result_6 =
  | { ok: [AccountIdentifier__1, [] | [Listing]] }
  | { err: CommonError };
export type Result_7 = { ok: AccountIdentifier__1 } | { err: CommonError };
export type Result__1 = { ok: null } | { err: null };
...
export type Style = { Old: string } | { Colors: Colors };
